...
void URender()
{
    ...
    glm::mat4 projection = glm::perspective(45.0f, (GLfloat)WINDOW_WIDTH / (GLfloat)WINDOW_HEIGHT, 0.1f, 50.0f);
    ...
    GLfloat verts[] = {
        ...
        ///Positions					//colors
            ...
            -0.5f, -0.5f, -0.5f,         0.5f, 0.5f, 1.0f, 1.0f,
             ...
             0.0f,  0.5f,  0.0f,         0.2f, 0.2f, 0.5f, 1.0f,
            ...
            -0.5f, -0.5f,  0.5f,         0.0f, 1.0f, 0.0f, 1.0f,
             ...
             0.5f, -0.5f, -0.5f,         0.2f, 0.2f, 0.5f, 1.0f,
             0.5f, -0.5f,  0.5f,         0.2f, 0.2f, 0.5f, 1.0f,
             0.0f, 0.5f, 0.0f,           0.2f, 0.2f, 0.5f, 1.0f,
